...
func TestExtensionModelJSONTags(t *testing.T) {
	tests := []struct {
		...
		{reflect.TypeOf(HardwareStats{}), "CPUDetails", "cpu_details"},
		{reflect.TypeOf(CPUUsageStats{}), "IOWaitPercent", "iowait_percent"},
		{reflect.TypeOf(MemoryDetails{}), "SwapUsedBytes", "swap_used_bytes"},
